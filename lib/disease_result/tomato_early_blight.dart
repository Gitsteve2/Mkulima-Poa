...
class TomatoEarlyBlightresult extends StatelessWidget {
  @override
    ...
    return SizedBox(
      ...
      child: ListView(
        ...
        children: [
          ...
          Container(
            child: Text(
              "Use certified pathogen-free seeds or transplantsLook for varieties that are resistant to the diseasPlant or transplant on raised beds to improve drainagOrient rows in the direction of main winds and avoid shaded areaSpace plants to allow the canopy to dry quickly after rainfall or irrigatioay mulch on the soil to keep plants from touching the soiMonitor fields for signs of the disease, particularly during wet weather. ",
              style: TextStyle(
                  fontSize: 16,
                  color: Colors.black.withOpacity(0.8),
                  fontWeight: FontWeight.w400),
